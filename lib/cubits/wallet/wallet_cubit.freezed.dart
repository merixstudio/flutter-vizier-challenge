...
class _$WalletStateTearOff {
  ...
  _Loaded loaded({required WalletModel wallet}) {
    return _Loaded(
      wallet: wallet,
    );
  }
...
abstract class _Initial extends WalletState {
...
abstract class _Loading extends WalletState {
...
class _$_Loaded extends _Loaded {
  const _$_Loaded({required this.wallet}) : super._();
...
abstract class _Loaded extends WalletState {
  const factory _Loaded({required WalletModel wallet}) = _$_Loaded;
...
/// @nodoc
class __$FailureCopyWithImpl<$Res> extends _$WalletStateCopyWithImpl<$Res>
...
class _$_Failure extends _Failure {
  ...
  @override
  String toString() {
    return 'WalletState.failure(error: $error)';
  }
...
abstract class _Failure extends WalletState {
